...
public final class ActivityNotificationBinding implements ViewBinding {
  ...
  @NonNull
  public final Button btnSendNotify;

  private ActivityNotificationBinding(@NonNull ConstraintLayout rootView,
      @NonNull Button btnSendNotify) {
    this.rootView = rootView;
    this.btnSendNotify = btnSendNotify;
  }
  ...
  public static ActivityNotificationBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.btn_send_notify;
      Button btnSendNotify = ViewBindings.findChildViewById(rootView, id);
      if (btnSendNotify == null) {
        break missingId;
      }

      return new ActivityNotificationBinding((ConstraintLayout) rootView, btnSendNotify);
    }
